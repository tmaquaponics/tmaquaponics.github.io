...
1. **Clarification and solids removal :** is the process of mechanically removing organic sedimentary and suspended solids like uneaten fish food and fish waste from the system. This is usually done using mechanical means like settlers or meshes/sponges.
2. **Biofiltration :** is the process of biologically removing inorganic contaminents from the water, such as amonia, nitrites and nitrates. This is usually done using MBBR systems.
...
Nitrates removal is one of the important processes in a RAS system. There are many ways to remove nitrates from a RAS, with some more comlicated than others. In this article, we previledge the removal of nitrates using plants as it is a fairly simple and somewhat cheap process that can be easily incorporated at any scale.
...
Another common point is that they lacked sophisticated filtration systems. Almost all designs were using sponge filters; a small number integrated sump systems to filter and link the tanks together. The later category was more appealing to me. 
