...
Since every level has three taps and three overflow tubings. The tanks are like modules and can be swapped in and out to change from one configuration to another. The benefit here is that the rack can evolve to meet your fish breeding needs.
